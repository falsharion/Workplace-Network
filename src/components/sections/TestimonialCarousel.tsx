...
const TESTIMONIALS = [
  {
    id: '1',
    quote: '"Excellence at Work: Refusing to Settle for Mediocrity."',
    body: "The video reminds us that mediocrity is not just about the quality of our work; it can gradually affect how we see ourselves and our potential. In the Christian workplace, we are called to approach our work with excellence because our work is ultimately an expression of our service to God. We should not be afraid to grow, improve, take initiative, and rise above what is merely “good enough.” When God has given us gifts, excellence is one way we steward those gifts and become a light in the workplace.",
    speaker: 'Debola Deji-Kurunmi',
    role: 'Author, Speaker, and Founder of IMMERSE Coaching Company',
    video: '/assets/DDK.MOV',
    poster: '/assets/DDKimg.png',
  },
  {
    id: '2',
...
// Fills its parent. Shows a shimmer skeleton until the image is ready,
// then cross-fades the image into view.
...
export function TestimonialCarousel() {
  ...
  return (
    <section
      ref={sectionRef}
      className="py-16 sm:py-20 bg-cream overflow-hidden"
    >
      <div className="max-w-5xl md:max-w-2xl w-full lg:max-w-4xl mx-auto px-7 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex gap-10 lg:gap-16 items-center">
          ...
          {/* Photo / Video */}
          <div
            className={`flex-shrink-0 w-52 lg:w-64 ${reveal()}`}
          >
            <div
              key={`d-photo-${current}`}
          ...
          {/* Quote + Body + Speaker + Arrows */}
          <div
            className={`flex-1 flex flex-col ${reveal(
          ...
          >
            ...
            {/* Arrow buttons */}
            <div
              className={`flex items-center gap-2 mt-8 self-end ${reveal(
                'scroll-reveal-delay-2'
              )}`}
            >
              <button
